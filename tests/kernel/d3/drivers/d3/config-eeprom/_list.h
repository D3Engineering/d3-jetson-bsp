/* Modified from include/linux/list.h by
 * Christopher White <cwhite@d3engineering.com>
 *
 * Copyright (c) 2005--2020, Linus Torvalds et al.  All rights reserved.
 ...
 * more details.
 *
 * Also includes content from include/linux/types.h
 */

#ifndef _LINUX_LIST_H
#define _LINUX_LIST_H

/* Material from other headers */
struct list_head {
