...
# Xavier. Xavier is the only system we use that needs this.
	...
	./mkbootimg --kernel $(kimagedest) --ramdisk /dev/null --board mmcblk01p1 --output $(TMPTOP)/boot/vmlinuz-$(KERNELRELEASE).img; \
	cd $(TMPTOP)/boot/; \
	$(L4TDIR)/bootloader/tegraflash.py --chip 0x19 --cmd "sign vmlinuz-$(KERNELRELEASE).img" --skipuid > /dev/null
